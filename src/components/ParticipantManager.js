        ...
        <div style={styles.container}>
            ...
            <div style={styles.stats}>
                ...
                <div style={{...styles.statBox, backgroundColor: '#e7fcef'}}>
                    ...
                    <span style={styles.statLabel}>Παρόντες</span>
                </div>
                <div style={{...styles.statBox, backgroundColor: '#fff0f0'}}>
                    <span style={{...styles.statNumber, color: '#ff6b6b'}}>✗ {uncheckedCount}</span>
                    <span style={styles.statLabel}>Απόντες</span>
                </div>
            </div>
                    ...
                    {participant.contact.firstName} {participant.contact.lastName}
                      ...
                      📞 {participant.contact.phone}
                            ...
                            <div style={{
                                ...
                                {participant.checked ? '✓ Παρών' : '✗ Απών'}
                            </div>
                        </div>
